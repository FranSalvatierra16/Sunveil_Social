...
import { BackIcon, Bold, Circle, Circle1, DynamicSunIcon, Font, Gif, ImageC, ImageSimple, Lock, Mute, Paleta, Pause, Pencil, Play, Plus, PlusIcon, PlusProfile, Search, Send, Time, Underline, Unfollow, Unlock, Vol } from '../../theme/Icons';
...
const ProfileUserFoll = ({ route }) => {
    const { profileImage, username2, followPriv } = route.params;
    const [selectImage, setSelectImage] = useState('')
    const [selectImage1, setSelectImage1] = useState('')
    const [post, setPost] = useState(true);
    const [board, setBoard] = useState(false);
    const [like, setLike] = useState(false);
    console.log(followPriv)
    ...
    console.log(profileImage, username2,);
    ...
    useEffect(() => {
        if (follow1 === '2') {
            const timeoutId = setTimeout(() => {
                setFollow1('1'); // Cambiar el valor de la variable después de 10 segundos
            }, 10000);

            return () => clearTimeout(timeoutId); // Limpiar el timeout en caso de que el componente se desmonte
        }
    }, [follow1]);
            ...
            <View style={{ flex: 1, backgroundColor: dark ? "#000000" : "#FFFFFF" }}>
                ...
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1, paddingTop: StatusBar.currentHeight }}>
                    <View style={{ width: '100%', flex: 1, }}>
                        {followPriv ? (
                            <>
                                <View style={{ width: '100%', flexDirection: "row", alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10, marginTop: '5%' }}>
                                        ...
                                        <View style={{
                                            ...
                                            {follow1 === '1' && (
                                                <>
                                                    ...
                                                    <DynamicSun sizeHeight={25} sizeWidth={25} colorCircle={selectedColor} colorPath={dark ? "#ffffff" : "#000000"}
                                                        style={{
                                                            position: 'absolute',
                                                            top: 25,
                                                            right: -40,
                                                        }}
                                                        onPress={() => followTrue('3')}
                                                    />
                                            ...
                                            {follow1 === '3' && (
                                                ...
                                                <TouchableOpacity style={{
                                                    ...
                                                    top: 25,
                                                    right: -40,
                                                }} onPress={() => followTrue('2')}>
                                                    <View style={{ width: 15, height: 15, backgroundColor: 'gray', borderRadius: 999, }} />
                                                    <Plus size={15} color={'gray'} top={-10} />
                                ...
                                <View style={{ width: '100%', flex: 1, alignItems: 'center' }}>
                                    <View style={{ justifyContent: 'center', alignItems: 'center', width: '80%' }}>
                                        <Text> World explorer 🌍  Photography enthusiast 📸  Adventurer in search of unique experiences 🌟  Sharing moments and reflections along the way. #Traveler #Adventures #Exploring</Text>
                                    </View>
                                    <View style={{
                                        width: '100%',
                                        flexDirection: "row",
                                    ...
                                    {follow1 === '2' && (
                                        <>
                                            ...
                                            <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%', height: '40%' }}
                                            >
                                                <Lock size={80} />
                                                <Text style={[style.s22, { color: 'gray' }]}>This account is private</Text>
                                                <Text style={[style.r16, { color: 'gray' }]}>Follow this account to see their photos and videos</Text>
                                            </View>
                                        </>
                                    )}
                                    {follow1 === '3' && (
...
export default ProfileUserFoll