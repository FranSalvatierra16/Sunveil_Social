...
import { View, Text, Image, ScrollView, TouchableOpacity, SafeAreaView, StyleSheet, StatusBar, Platform, KeyboardAvoidingView, Switch, Animated, TextInput, ImageBackground } from 'react-native';
                ...
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{
                    ...
                    >
                        <View style={{ flex: 1, }}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', width: '96%', marginLeft: '2%', justifyContent: 'space-between', marginTop: '5%', }}>
                                <TouchableOpacity onPress={() => navigation.goBack()}>
                                    <Cross size={20} color={dark ? "#FFFFFF" : "#000000"} />
                                </TouchableOpacity>
                        ...
                        <View style={{ flex: 1, }}>
                            ...
                            <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: '2%', height: '80%' }}>

                                {selectImage ? (
                                    <>
                                        <ImageBackground style={{ width: '94%', height: '100%', marginLeft: '3%', borderRadius: 12, marginTop: '10%' }} source={{ uri: selectImage }} >

                                            <TouchableOpacity style={{ width: '94%', height: '20%', backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }} onPress={() => setButton1(!button1)}>
                                                {button1 ? (
                                                    <View style={{ width: '70%', borderRadius: 15, backgroundColor: 'black', opacity: 0.6, justifyContent: 'center', alignItems: 'center', }}>
                                                        <TextInput
                                                            style={[style.s18, { color: '#ffffff' }]}
                                            ...
                                            <TouchableOpacity style={{ width: '94%', height: '20%', backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }} onPress={() => setButton2(!button2)}>
                                                {button2 ? (
                                                    <View style={{ width: '70%', borderRadius: 15, backgroundColor: 'black', opacity: 0.6, justifyContent: 'center', alignItems: 'center', }}>
                                                        <TextInput
                                                            style={[style.s18, { color: '#ffffff' }]}
                                                            onChangeText={setText22}
                                                            value={text22}
                                                            placeholder="Send Message"
                                                            placeholderTextColor="#6E707A"
                                            ...
                                            <TouchableOpacity style={{ width: '94%', height: '20%', backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }} onPress={() => setButton3(!button3)}>
                                                {button3 ? (
                                                    <View style={{ width: '70%', borderRadius: 15, backgroundColor: 'black', opacity: 0.6, justifyContent: 'center', alignItems: 'center', }}>
                                                        <TextInput
                                                            style={[style.s18, { color: '#ffffff' }]}
                                            ...
                                            <TouchableOpacity style={{ width: '94%', height: '20%', backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }} onPress={() => setButton4(!button4)}>
                                                {button4 ? (
                                                    <View style={{ width: '70%', borderRadius: 15, backgroundColor: 'black', opacity: 0.6, justifyContent: 'center', alignItems: 'center', }}>
                                                        <TextInput
                                                            style={[style.s18, { color: '#ffffff' }]}
                                            ...
                                            <TouchableOpacity style={{ width: '94%', height: '20%', backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }} onPress={() => setButton5(!button5)}>
                                                {button5 ? (
                                                    <View style={{ width: '70%', borderRadius: 15, backgroundColor: 'black', opacity: 0.6, justifyContent: 'center', alignItems: 'center', }}>
                                                        <TextInput
                                                            style={[style.s18, { color: '#ffffff' }]}
                                        ...
                                        <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%', }}>
                                            <TouchableOpacity style={{ width: 300, height: 50, borderRadius: 16, backgroundColor: '#FF9900', marginTop: '2%', justifyContent: 'center', alignItems: 'center' }}>
                                                <Text style={[style.r20, { color: 'white' }]}>Add to history</Text>
                                            </TouchableOpacity>
                                        </View>
                                    </>
                                ) : (
                                    <>
                                        <ImageBackground
                                            source={require('../../../img/fondo10.jpg')}
                                            style={{ width: '94%', height: '95%', marginLeft: '3%', borderRadius: 12, marginTop: '5%' }}
                                        >
                                            <TouchableOpacity style={{ width: '94%', height: '20%', backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center' }} onPress={() => setButton1(!button1)}>
                                                {button1 ? (
                                                    <View style={{ width: '70%', borderRadius: 15, backgroundColor: 'black', opacity: 0.6, justifyContent: 'center', alignItems: 'center', }}>
